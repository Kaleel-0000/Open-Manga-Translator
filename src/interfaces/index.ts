// ============================================================
// Core domain interfaces — every major component is replaceable
// ============================================================
...
export interface ExtensionSettings {
  enabled: boolean;
  targetLang: string;
  sourceLang: string;       // 'auto' or ISO 639-1
  ocrProvider: string;      // provider id
  translationProvider: string;
  apiKeys: Record<string, string>;
  localModelEndpoint: string;  // e.g. http://localhost:11434
  fontFamily: string;
  maxFontSize: number;
...
// ------------------------------------------------------------------
// Messaging protocol (background ↔ content ↔ popup)
// ------------------------------------------------------------------
